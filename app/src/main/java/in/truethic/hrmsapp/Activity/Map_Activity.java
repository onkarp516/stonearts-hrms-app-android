...
public class Map_Activity extends AppCompatActivity implements LocationListener{
...
//    ProgressDialog progressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(Map_Activity.this);
        ...
        client = LocationServices.getFusedLocationProviderClient(Map_Activity.this);
        ...
        /*if(Globals.isGpsClicked) {
            tv_check_in.setVisibility(View.GONE);
            Globals.isGpsClicked=false;
        }
        else {
            tv_check_in.setVisibility(View.VISIBLE);
        }*/
        ...
        tv_check_in.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(canTakeAttedance)
                {
                    ...
                    Intent i = new Intent(Map_Activity.this,Selfie_Activity.class);
                    startActivity(i);
                    finish();
                }
                else
                {
                    if(Globals.emp_username.equalsIgnoreCase("1234567890"))
                    {
                        ...
                        DisplayDialogBox.showDialogBox(Map_Activity.this,"Your are out of office location By "+site_R+" Meters","GPS Alert");
                    }
                }
            }
        });
        iv_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                locationManager.requestSingleUpdate(LocationManager.FUSED_PROVIDER, Map_Activity.this, null);
            }
        });
        ...
        locationManager.requestSingleUpdate(LocationManager.FUSED_PROVIDER, (LocationListener) Map_Activity .this, null);
    ...
    private void loadMap() {
        if (ActivityCompat.checkSelfPermission(Map_Activity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            if (currentLocation != null) {
                ...
                Toast.makeText(Map_Activity.this, "Unable to get current location", Toast.LENGTH_LONG).show();
            }
        } else {
            ActivityCompat.requestPermissions(Map_Activity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1001);
        }
    }
    ...
    private void getCurrentLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            // to handle the case where the user grants the permission. See the documentation
            // for ActivityCompat#requestPermissions for more details.
            Toast.makeText(Map_Activity.this,"No location permission granted",Toast.LENGTH_LONG).show();
                ...
                supportMapFragment.getMapAsync(new OnMapReadyCallback() {
                    ...
                    public void onMapReady(@NonNull GoogleMap googleMap) {
                        ...
                        if (currentLocation != null) {
                            ...
                            Toast.makeText(Map_Activity.this, "Unable to get current location for the map", Toast.LENGTH_LONG).show();
                        }
                    }
                });
            } else {
